...
const Sidebar: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V5a2 2 0 00-2-2M5 11V5a2 2 0 00-2 2m14 0a2 2 0 002 2h2a2 2 0 002-2M5 11a2 2 0 002 2h2a2 2 0 002-2" />
        </svg>
      ),
      roles: ['school_admin']
    },
              ...
              <Link
                ...
                className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors
                  ${location.pathname === item.path
                    ? 'bg-green-50 text-green-700 font-semibold border-l-4 border-green-600 shadow'
